...
# 设定模型路径
MODEL_PATH = r"E:\Desktop\莫愁师姐平台部署\训练模型\AdaBoost_optimized_model.pkl"
...
# ✅ 设置页面标题
st.title("🧪 Protein Separation Prediction Platform - Based on AdaBoost Machine Learning Model")
st.write("""
...
X_1 = st.sidebar.number_input("KH550 (volume/mL)", value=1.0)
